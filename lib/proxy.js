...
`);
     ...
     */
    match(pattern, opts) {
        const parse = kit.requireOptional('path-to-regexp', __dirname, '^1.2.0');
        const keys = [];
    ...
    static(opts) {
        ...
        const send = kit.requireOptional('send', __dirname, '^0.15.0');
